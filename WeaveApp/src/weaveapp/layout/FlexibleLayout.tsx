...
import Layout = weavejs.ui.layout.Layout;
import LayoutState = weavejs.ui.layout.LayoutState;
...
import {AbstractLayout, LayoutProps, PanelDragEvent, AnyAbstractLayout} from "weaveapp/layout/AbstractLayout";
...
{
	static WEAVE_INFO = Weave.setClassInfo(FlexibleLayout, {
