namespace weavejs.util
{
	export class JS
	{
		 ...
		 */
		public static compile(script:string, paramNames:string[] = null, errorHandler:(e:Error)=>void):Function
		{
			try
			{
		 ...
		 */
		public static toArray(value:any):Array
		{
		 ...
		 */
		public static asClass(classDef:any):Class
		{
