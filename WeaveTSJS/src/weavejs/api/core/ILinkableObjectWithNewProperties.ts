...
namespace weavejs.api.core
{
	 ...
	 */
	@Weave.classInfo({id: "weavejs.api.core.ILinkableObjectWithNewProperties"})
	export class ILinkableObjectWithNewProperties extends ILinkableObject
	{
		/**
		 ...
		 */
		deprecatedStateMapping:((newState:UnTypedState) => void)|UnTypedState;
	}
}
