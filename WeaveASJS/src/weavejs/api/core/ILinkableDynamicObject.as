...
package weavejs.api.core
{
	...
	public interface ILinkableDynamicObject extends ILinkableCompositeObject
	{
		 ...
		 */
		function requestGlobalObject/*/<T extends ILinkableObject>/*/(name:String, objectType:/*/Class<T> | string/*/Class, lockObject:Boolean = false):/*/T/*/*;
		 ...
		 */
		function requestLocalObject/*/<T extends ILinkableObject>/*/(objectType:/*/Class<T> | string/*/Class, lockObject:Boolean = false):/*/T/*/*;
