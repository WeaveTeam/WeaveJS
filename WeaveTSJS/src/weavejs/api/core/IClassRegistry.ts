...
namespace weavejs.api.core
{
	...
	export class IClassRegistry
	{
		 ...
		 */
		registerClass:(definition:GenericClass, qualifiedName:string, interfaces:GenericClass[] = null, displayName:string = null) => void;
		 ...
		 */
		registerImplementation:<T>(theInterface:Class<T>, theImplementation:Class<T>, displayName:string = null)=>void;
