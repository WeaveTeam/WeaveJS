...
namespace weavejs.api.core
{
	...
	export class ISessionManager
	{
		 ...
		 */
		newLinkableChild:<T extends ILinkableObject>(linkableParent:Object, linkableChildType:Class<T>, callback:() => void = null, useGroupedCallback:boolean = false) => T;
		 ...
		 */
		registerLinkableChild:<T extends ILinkableObject>(linkableParent:Object, linkableChild:T, callback:() => void = null, useGroupedCallback:boolean = false) => T;
		 ...
		 */
		getLinkableDescendants:<T>(root:ILinkableObject, filter:Class<T> = null) => Array<T & ILinkableObject>;
		 ...
		 * @see #getSessionState()
		 */
		setSessionState:(linkableObject:ILinkableObject, newState:SessionState, removeMissingDynamicObjects:boolean = true) => void;
		 ...
		 * @see #setSessionState()
		 */
		getSessionState:(linkableObject:ILinkableObject) => SessionState;
		 ...
		 * @see #combineDiff()
		 */
		computeDiff:(oldState:SessionState, newState:SessionState) => SessionState;
		 ...
		 * @see #computeDiff()
		 */
		combineDiff:(baseDiff:SessionState, diffToAdd:SessionState) => SessionState;
		 ...
		 * @see #setSessionState()
		 */
		copySessionState:(source:ILinkableObject, destination:ILinkableObject) => SessionState;
