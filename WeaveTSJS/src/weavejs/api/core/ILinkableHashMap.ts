...
namespace weavejs.api.core
{
	...
	export class ILinkableHashMap<T extends ILinkableObject> extends ILinkableCompositeObject
	{
		/**
		 * The child type restriction, or null if there is none.
		 */
		typeRestriction:Class<T>;
		 ...
		 */
		getNames:(filter:Class<T> | string = null, filterIncludesPlaceholders:boolean = false) => string[];
		 ...
		 */
		getObjects:<T>(filter:Class<T> | string = null, filterIncludesPlaceholders:boolean = false) => Array<T & ILinkableObject>;
		 ...
		 */
		toObject:<T>(filter:Class<T> | string = null, filterIncludesPlaceholders:boolean = false) => {[name:string]: T & ILinkableObject};
		 ...
		 */
		toMap:<T>(filter:Class<T> | string = null, filterIncludesPlaceholders:boolean = false) =>Map<string, T & ILinkableObject>;
		 ...
		 */
		setObject:(name:string, object:T, lockObject:boolean = false) => void;
		 ...
		 */
		requestObject:<T>(name:string, classDef:Class<T> | string, lockObject:boolean = false) => T;
