...
declare module "material-ui" {
    ...
    export import Menu = __MaterialUI.Menus.Menu; // require('material-ui/lib/menu/menu');
    export import MenuItem = __MaterialUI.Menus.MenuItem; // require('material-ui/lib/menu/menu-item');
