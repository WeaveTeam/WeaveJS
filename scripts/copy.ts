module.exports = function()
{
	...
	let targets:{[name:string]:TargetEntry} = {
		index_html: {flatten: true, cwd: 'WeaveApp/src/', src: 'index.html', dest: 'WeaveApp/dist/'},
		weave_html: {flatten: true, cwd: 'WeaveApp/src/', src: 'weave.html', dest: 'WeaveApp/dist/'},
		css: {flatten: true, cwd: 'WeaveApp/src/', src: 'css/*.css', dest: 'WeaveApp/dist/css/'},
		img: {flatten: true, cwd: 'WeaveApp/src/', src: 'img/*.*', dest: 'WeaveApp/dist/img'},
		fonts: {flatten: true, cwd: 'WeaveApp/src/', src: 'css/fonts/*.ttf', dest: 'WeaveApp/dist/fonts'},
		...
		semanticjs: {cwd: 'WeaveApp/src/semantic', src: 'semantic.min.js', dest: 'WeaveApp/dist/'},
		semanticcss: {cwd: 'WeaveApp/src/semantic', src: 'semantic.min.css', dest: 'WeaveApp/dist/css/'},
		semanticfonts: {cwd: 'WeaveApp/src/semantic/themes', src: '*', dest: 'WeaveApp/dist/css/themes/'},
		weavesessions: {flatten: true, cwd: 'weave_sessions', src: "*.weave", dest: "WeaveApp/dist/"},
		projdb: {flatten: true, cwd: 'WeaveApp/src/', src: 'ProjDatabase.zip', dest: "WeaveApp/dist/"}
	};
