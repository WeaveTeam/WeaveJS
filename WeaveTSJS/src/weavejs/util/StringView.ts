namespace weavejs.util
{
	export class StringView
	{
		...
		constructor (vInput:any, sEncoding:string = null/* optional (default: UTF-8) */, nOffset:number = NaN/* optional */, nLength:number = NaN/* optional */) {
			...
			var fTAView:Class, aWhole:any, aRaw:any, fPutOutptCode:Function, fGetOutptChrSize:Function, nInptLen:number, nStartIdx:number = isFinite(nOffset) ? nOffset : 0, nTranscrType:number = 15;
		...
		public static bytesToBase64(aBytes:any[]):string {
