...
export default class ColumnSelector extends React.Component<IColumnSelectorProps, IColumnSelectorState>
{
	...
	componentWillReceiveProps(nextProps:IColumnSelectorProps)
	{
	...
	render():JSX.Element
	{
		...
		let dependencies = ColumnSelector.getDataSourceDependencies(attribute) as ILinkableObject[];
