...
namespace weavejs.api.core
{
  ...
  /**
	...
	export class ICallbackCollection extends ILinkableObject
	{
		 ...
		 */
		addImmediateCallback:(relevantContext:Object, callback:() => void, runCallbackNow?:boolean, alwaysCallLast?:boolean)=>void;
		 ...
		 */
		addGroupedCallback:(relevantContext:Object, groupedCallback:() => void, triggerCallbackNow?:boolean, delayWhileBusy?:boolean)=>void;
		 ...
		 */
		addDisposeCallback:(relevantContext:Object, callback:() => void, allowDelay?:boolean)=>void;
