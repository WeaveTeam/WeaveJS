...
namespace weavejs.api.core
{
	...
	export class ILinkableDynamicObject extends ILinkableCompositeObject
	{
		 ...
		 */
		requestGlobalObject:<T extends ILinkableObject>(name:string, objectType:Class<T> | string, lockObject:boolean = false) => T;
		 ...
		 */
		requestLocalObject:<T extends ILinkableObject>(objectType:Class<T> | string, lockObject:boolean = false) => T;
