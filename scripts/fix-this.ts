module.exports = function()
{
	...
	var d_filename_lines_replacements:Map<string, Map<number, {column:number, original:string, replacement:string}[]>> = new Map();
	...
	function processErrorLine(line:string)
	{
		...
		if (match)
		{
			...
			replacements.push({column: columnNum, original, replacement});
		}
	}
