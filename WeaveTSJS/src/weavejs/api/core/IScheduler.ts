...
{
	@Weave.classInfo({id: "weavejs.api.core.IScheduler"})
	export class IScheduler
	{
		 ...
		 */
		startTask:(relevantContext:Object, iterativeTask:Function, priority:uint, finalCallback?:Function, description?:string) => void;
	}
}
