...
import HierarchyExplorer from "weaveapp/ui/HierarchyExplorer";
import ButtonGroupBar from "weaveapp/ui/ButtonGroupBar";
...
export default class AttributeSelector extends SmartComponent<IAttributeSelectorProps, IAttributeSelectorState>
{
	...
	static openInstance(context:React.ReactInstance, attributeName:string, attributes:Map<string, IColumnWrapper|ILinkableHashMap>):ControlPanel
	{
		...
		return ControlPanel.openInstance(
			weave,
			AttributeSelector,
			{context: context, title: Weave.lang('Attribute Selector')},
