...
namespace weavejs.core
{
  ...
  export class LinkableVariable extends CallbackCollection implements ILinkableVariable, ICallbackCollection, IDisposableObject
  {
    /**
     ...
     */
    protected _verifier:(value:any) => boolean = null;
     ...
     */
    protected _sessionStateInternal:any = undefined;

    /**
     * Available externally via getSessionState()
     */
    protected _sessionStateExternal:any = undefined;
     ...
     */
    constructor(sessionStateType:GenericClass = null, verifier:(value:any) => boolean = null, defaultValue:any = undefined, defaultValueTriggersCallbacks:boolean = true)
    {
      super();
     ...
     */
    private verifyValue(value:any):boolean
    {
     ...
     */
    public getSessionStateType():GenericClass
    {
    ...
    public setSessionState(value:any):void
    {
      if (this._locked)
        return;
    ...
    private objectCompare(a:any&SessionState, b:any&SessionState):number
    {
