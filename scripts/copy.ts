module.exports = function()
{
	...
	let targets:{[name:string]:TargetEntry} = {
		...
		olcss: {flatten: true, cwd: 'node_modules/openlayers/css', src: 'ol.css', dest: 'WeaveApp/dist/css/'},
                fontawesomecss: {flatten: true, cwd: 'WeaveApp/node_modules/font-awesome/css', src: 'font-awesome.css', dest: 'WeaveApp/dist/css/'},
                fontawesomefont: {flatten: true, cwd: 'WeaveApp/node_modules/font-awesome/fonts', src: '*', dest: 'WeaveApp/dist/fonts/'},
