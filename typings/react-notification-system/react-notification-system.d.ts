...
declare namespace NotificationSystem {
	...
	export class System extends React.Component<NotificationSystem.Attributes, {}> {
	...
	export interface Attributes {
		noAnimation?: boolean;
		ref?: string | ((classInstance:NotificationSystem.System) => void);
		style?: Style | boolean;
	}
}
...
declare module 'react-notification-system' {
	const System: typeof NotificationSystem.System;
	export = System;
}