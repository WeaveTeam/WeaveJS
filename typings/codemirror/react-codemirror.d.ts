...
declare namespace ReactCodeMirrorNamespace {
...
declare var ReactCodeMirror:ReactCodeMirrorNamespace.ReactCodeMirrorClass;

declare module "react-codemirror" {
    const RCM: ReactCodeMirrorNamespace.ReactCodeMirrorClass;
    export = RCM;
}
